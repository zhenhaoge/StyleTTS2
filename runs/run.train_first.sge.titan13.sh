...
#
# example:
# /home/users/zge/bin/run_gpu_job.sh run.train_first.sge.sh titan16 Logs/test.log 2 "stylett2-first"
# /home/users/zge/bin/run_gpu_job.sh run.train_first.sge.titan13.sh titan13 Logs/train.log 4 "ST2-first"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --main_process_port 29501 train_first.py \
