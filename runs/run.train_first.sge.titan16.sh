...
#
# example:
# /home/users/hkwon/bin/run_gpu_job.sh run.train_first.sge.sh titan16 Logs/test.log 2 "styletts2-first"
# 
...
CUDA_VISIBLE_DEVICE=0,1,2,3,4,5,6,7 accelerate launch --main_process_port 29501 train_first.py \
