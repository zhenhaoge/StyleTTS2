...
# CUDA_VISIBLE_DEVICES=0,1,2 python train_second.py --config_path ./Configs/config_ljspeech_second.yml
CUDA_VISIBLE_DEVICES=0,1,2,3 python train_second.py --config_path ./Configs/config_gigaspeech_10p_second.yml